        ...
        test_users = [
            {
                ...
                'assessment': {
                    ...
                    'wrapping_up_open_to_multiple_matches': 'Yes, I\'m open to connecting with multiple people'
                }
            },
            {
                'username': 'bob_jones',
            ...
            },
            {
                ...
                'assessment': {
                    ...
                    'wrapping_up_open_to_multiple_matches': 'No, I prefer to focus on one match at a time'
                }
            },
            {
                'username': 'david_kim',
                ...
                'assessment': {
                    ...
                    'wrapping_up_gender_preference': ['Any gender'],
                    'wrapping_up_age_preference': ['25-34', '35-44'],
                    'wrapping_up_open_to_multiple_matches': 'I\'m not sure'
                }
            },
            {
                'username': 'emma_chen',
                ...
                'email': 'emma@test.com',
                'password': 'Test123!',
                'bio': 'Entrepreneur and fitness enthusiast. Building community through wellness.',
                'assessment': {
                    'tell_us_more_what_brings_you': 'I want to connect with ambitious women who prioritize health and growth',
                    'tell_us_more_friendship_meaning': 'Having a supportive network of people who push you to be better',
                    'friendship_readiness_emotional_availability': '7',
                    'friendship_readiness_time_energy_capacity': 'I\'m busy but make time for the right people',
                    'friendship_readiness_friendship_intention': 'Building a strong support network',
                    'friendship_readiness_personal_work': 'Yes - I invest in coaching and personal development',
                    'friendship_readiness_showing_up': 'Being reliable, celebrating wins, and giving honest feedback',
                    'personality_social_style_recharge_style': '2',
                    'personality_social_style_social_settings': 'I\'m usually the one starting conversations',
                    'personality_social_style_ideal_hangout_0': '2',
                    'personality_social_style_ideal_hangout_1': '3',
                    'personality_social_style_ideal_hangout_2': '1',
                    'personality_social_style_ideal_hangout_3': '4',
                    'personality_social_style_making_plans': 'I like to plan ahead',
                    'personality_social_style_communication_preference': ['Text/messaging', 'Phone/video calls'],
                    'personality_social_style_texting_style': 'I respond pretty quickly',
                    'conflict_repair_conflict_response': 'I address it directly but calmly',
                    'conflict_repair_repair_looks_like': ['Having a conversation about it', 'Taking accountability'],
                    'conflict_repair_flaky_friend_scenario': 'I\'d bring it up directly and set expectations',
                    'conflict_repair_feedback_comfort': '5',
                    'conflict_repair_hurt_feelings_needs_0': '1',
                    'conflict_repair_hurt_feelings_needs_1': '2',
                    'conflict_repair_hurt_feelings_needs_2': '3',
                    'conflict_repair_hurt_feelings_needs_3': '4',
                    'conflict_repair_hurt_feelings_needs_4': '5',
                    'conflict_repair_boundary_setting': 'I\'m comfortable setting clear boundaries',
                    'conflict_repair_friendship_lessons': 'Clear is kind - don\'t avoid hard conversations',
                    'hobbies_interests_activities_interests': ['Fitness/sports', 'Reading', 'Coffee shops'],
                    'hobbies_interests_want_to_try': 'CrossFit and networking events',
                    'hobbies_interests_free_time': 'Working out, reading business books, meeting new people',
                    'hobbies_interests_doing_vs_being': 'More of a doing friend',
                    'values_top_values_0': '2',
                    'values_top_values_1': '4',
                    'values_top_values_2': '1',
                    'values_top_values_3': '3',
                    'values_top_values_4': '5',
                    'values_top_values_5': '7',
                    'values_top_values_6': '6',
                    ...
                    'values_top_values_8': '9',
                    'values_top_values_9': '10',
                    'friendship_values_statements_resonate': ['I value shared activities and experiences', 'I need consistency and reliability', 'I appreciate people who challenge me to grow'],
                    'friendship_values_friendship_needs': ['Quality time', 'Shared hobbies', 'Mutual support'],
                    'friendship_values_non_negotiables': 'Ambition, honesty, and reliability',
                    'friendship_values_dealbreakers': 'Negativity, victim mentality, flakiness',
                    'friendship_values_connection_language_0': '2',
                    'friendship_values_connection_language_1': '3',
                    'friendship_values_connection_language_2': '1',
                    'friendship_values_connection_language_3': '4',
                    'friendship_values_connection_language_4': '5',
                    'friendship_values_connection_language_5': '6',
                    'logistics_connection_frequency': 'A few times a month',
                    'logistics_connection_type': 'Mix of in-person and virtual',
                    'wrapping_up_ideal_friend_words_word1': 'Driven',
                    'wrapping_up_ideal_friend_words_word2': 'Supportive',
                    'wrapping_up_ideal_friend_words_word3': 'Fun',
                    'wrapping_up_what_can_offer': 'Motivation, accountability, and genuine support',
                    'wrapping_up_what_want_receive': 'Someone who\'s going places and will celebrate with me',
                    'wrapping_up_gender_preference': ['Women'],
                    'wrapping_up_age_preference': ['25-34', '35-44'],
                    'wrapping_up_open_to_multiple_matches': 'Yes, I\'m open to connecting with multiple people'
                }
            },
            {
                ...
                'password': 'Test123!',
                'bio': 'Dad, runner, and weekend warrior. Looking for active friends and good company.',
                'assessment': {
                    'tell_us_more_what_brings_you': 'My kids are older now and I realize I need adult friendships',
                    'tell_us_more_friendship_meaning': 'People you can count on who make life more enjoyable',
                    'friendship_readiness_emotional_availability': '6',
                    'friendship_readiness_time_energy_capacity': 'I can make time on weekends mostly',
                    'friendship_readiness_friendship_intention': 'Making a few good friends to do activities with',
                    'friendship_readiness_personal_work': 'Some - trying to be more present and less in my head',
                    'friendship_readiness_showing_up': 'Being reliable and making plans happen',
                    'personality_social_style_recharge_style': '3',
                    'personality_social_style_social_settings': 'I observe first, then engage when comfortable',
                    'personality_social_style_ideal_hangout_0': '2',
                    'personality_social_style_ideal_hangout_1': '3',
                    ...
                    'personality_social_style_texting_style': 'I respond thoughtfully when I have time',
                    'conflict_repair_conflict_response': 'I need time to process before discussing',
                    'conflict_repair_repair_looks_like': ['Having a conversation about it', 'Moving forward together'],
                    'conflict_repair_flaky_friend_scenario': 'I\'d probably let it slide a few times before saying something',
                    'conflict_repair_feedback_comfort': '3',
                    'conflict_repair_hurt_feelings_needs_0': '2',
                    'conflict_repair_hurt_feelings_needs_1': '1',
                    ...
                    'conflict_repair_hurt_feelings_needs_3': '4',
                    'conflict_repair_hurt_feelings_needs_4': '5',
                    'conflict_repair_boundary_setting': 'I struggle with setting boundaries',
                    'conflict_repair_friendship_lessons': 'Show up even when it\'s hard',
                    'hobbies_interests_activities_interests': ['Fitness/sports', 'Hiking/outdoors', 'Cooking/baking'],
                    'hobbies_interests_want_to_try': 'Trail running and grilling with friends',
                    'hobbies_interests_free_time': 'Running, hiking, watching my kids\' games',
                    'hobbies_interests_doing_vs_being': 'More of a doing friend',
                    'values_top_values_0': '1',
                    'values_top_values_1': '2',
                    'values_top_values_2': '4',
                    ...
                    'values_top_values_8': '9',
                    'values_top_values_9': '10',
                    'friendship_values_statements_resonate': ['I need consistency and reliability', 'I value shared activities and experiences', 'I appreciate humor and lightheartedness'],
                    'friendship_values_friendship_needs': ['Shared hobbies', 'Quality time', 'Fun and laughter'],
                    'friendship_values_non_negotiables': 'Honesty and showing up',
                    'friendship_values_dealbreakers': 'Drama and unreliability',
                    'friendship_values_connection_language_0': '2',
                    'friendship_values_connection_language_1': '3',
                    'friendship_values_connection_language_2': '1',
                    'friendship_values_connection_language_3': '4',
                    ...
                    'logistics_connection_frequency': 'A few times a month',
                    'logistics_connection_type': 'In-person primarily, with texting in between',
                    'wrapping_up_ideal_friend_words_word1': 'Reliable',
                    'wrapping_up_ideal_friend_words_word2': 'Easy-going',
                    'wrapping_up_ideal_friend_words_word3': 'Active',
                    'wrapping_up_what_can_offer': 'Loyalty, humor, and adventure',
                    'wrapping_up_what_want_receive': 'Someone who shows up and keeps things light',
                    'wrapping_up_gender_preference': ['Any gender'],
                    'wrapping_up_age_preference': ['35-44', '45-54'],
                    'wrapping_up_open_to_multiple_matches': 'Yes, I\'m open to connecting with multiple people'
                }
            ...
            {
                'username': 'grace_patel',
                'first_name': 'Grace',
                'last_name': 'Patel',
                'email': 'grace@test.com',
                'password': 'Test123!',
                'bio': 'Therapist and bookworm. Seeking deep, authentic connections.',
                'assessment': {
                    'tell_us_more_what_brings_you': 'I help people all day and need friends who can reciprocate emotional support',
                    'tell_us_more_friendship_meaning': 'A safe space to be fully yourself without judgment',
                    'friendship_readiness_emotional_availability': '9',
                    'friendship_readiness_time_energy_capacity': 'I prioritize my friendships despite a busy schedule',
                    'friendship_readiness_friendship_intention': 'Building deep, meaningful connections',
                    'friendship_readiness_personal_work': 'Yes, continuously - I practice what I preach',
                    'friendship_readiness_showing_up': 'Deep listening, holding space, being present',
                    'personality_social_style_recharge_style': '4',
                    'personality_social_style_social_settings': 'I observe first, then engage when comfortable',
                    'personality_social_style_ideal_hangout_0': '1',
                    'personality_social_style_ideal_hangout_1': '2',
                    ...
                    'conflict_repair_hurt_feelings_needs_4': '5',
                    'conflict_repair_boundary_setting': 'I\'m comfortable setting clear boundaries',
                    'conflict_repair_friendship_lessons': 'Healthy friendships require both vulnerability and boundaries',
                    'hobbies_interests_activities_interests': ['Reading', 'Yoga/meditation', 'Coffee shops'],
                    'hobbies_interests_want_to_try': 'Book clubs and meditation retreats',
                    'hobbies_interests_free_time': 'Reading, journaling, having meaningful conversations',
                    'hobbies_interests_doing_vs_being': 'More of a being friend',
                    'values_top_values_0': '1',
                    'values_top_values_1': '3',
                    'values_top_values_2': '2',
                    ...
                    'friendship_values_statements_resonate': ['I value depth over quantity', 'I appreciate vulnerability and realness', 'I\'m drawn to emotional intimacy'],
                    'friendship_values_friendship_needs': ['Deep conversations', 'Emotional support', 'Mutual growth'],
                    'friendship_values_non_negotiables': 'Emotional intelligence, authenticity, and reciprocity',
                    'friendship_values_dealbreakers': 'Emotional unavailability and lack of self-awareness',
                    'friendship_values_connection_language_0': '4',
                    'friendship_values_connection_language_1': '1',
                    'friendship_values_connection_language_2': '3',
                    'friendship_values_connection_language_3': '2',
                    ...
                    'logistics_connection_frequency': 'Weekly or a few times a month',
                    'logistics_connection_type': 'In-person primarily, with texting in between',
                    'wrapping_up_ideal_friend_words_word1': 'Empathetic',
                    'wrapping_up_ideal_friend_words_word2': 'Thoughtful',
                    'wrapping_up_ideal_friend_words_word3': 'Genuine',
                    'wrapping_up_what_can_offer': 'Deep presence, empathy, and unwavering support',
                    'wrapping_up_what_want_receive': 'Someone who values emotional depth and shows up consistently',
                    'wrapping_up_gender_preference': ['Women', 'Non-binary'],
                    'wrapping_up_age_preference': ['25-34', '35-44', '45-54'],
                    'wrapping_up_open_to_multiple_matches': 'No, I prefer to focus on one match at a time'
                }
            }
        ]
